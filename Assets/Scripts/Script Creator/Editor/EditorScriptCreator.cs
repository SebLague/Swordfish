...
public class EditorScriptCreator {
	...
	[MenuItem("Assets/Create/Editor Script %#a", false, 81)] // guesswork required for priorities (or reflector to look at source)
	...
	[MenuItem("Assets/Create/Editor Script %#a", true)]
